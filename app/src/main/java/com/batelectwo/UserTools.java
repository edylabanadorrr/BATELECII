...
public class UserTools extends AppCompatActivity {

    private FirebaseAuth authProfile;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.user_tools);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
                        ...
                        if (dataSnapshot.exists()) {
                            ...
                            if (role != null) {
                                if (role.equals("admin")) {
                                    ...
                                    Intent adminIntent = new Intent(UserTools.this, AdminInterface.class);
                                    adminIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                    startActivity(adminIntent);
                                } else if (role.equals("consumer")) {
                                    // Handle actions for Consumer role
                                    Intent consumerIntent = new Intent(UserTools.this, ConsumerInterface.class);
                                    ...
                                    Toast.makeText(UserTools.this, "Unauthorized action for this role", Toast.LENGTH_SHORT).show();
                                }
                            }
                        }
                    }
            ...
            Toast.makeText(UserTools.this, "Something went wrong", Toast.LENGTH_SHORT).show();
        }
