...
public class UserContact extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
                        ...
                        if (dataSnapshot.exists()) {
                            ...
                            if (role != null) {
                                if (role.equals("admin")) {
                                    ...
                                    Intent adminIntent = new Intent(UserContact.this, AdminInterface.class);
                                    adminIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                    startActivity(adminIntent);
                                } else if (role.equals("consumer")) {
                                    // Handle actions for Consumer role
                                    Intent consumerIntent = new Intent(UserContact.this, ConsumerInterface.class);
                                    ...
                                    Toast.makeText(UserContact.this, "Unauthorized action for this role", Toast.LENGTH_SHORT).show();
                                }
                            }
                        }
                    }
            ...
            Toast.makeText(UserContact.this, "Something went wrong", Toast.LENGTH_SHORT).show();
        }
