...
public class UserAbout extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
                        ...
                        if (dataSnapshot.exists()) {
                            ...
                            if (role != null) {
                                if (role.equals("admin")) {
                                    ...
                                    Intent adminIntent = new Intent(UserAbout.this, AdminSettings.class);
                                    adminIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                    startActivity(adminIntent);
                                } else if (role.equals("consumer")) {
                                    // Handle actions for Consumer role
                                    Intent consumerIntent = new Intent(UserAbout.this, UserSettings.class);
                                    ...
                                    Toast.makeText(UserAbout.this, "Unauthorized action for this role", Toast.LENGTH_SHORT).show();
                                }
                            }
                        }
                    }
            ...
            Toast.makeText(UserAbout.this, "Something went wrong", Toast.LENGTH_SHORT).show();
        }
