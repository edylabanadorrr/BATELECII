...
public class UserPrecautions extends AppCompatActivity {
    private FirebaseAuth authProfile;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.user_precautions);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
                        ...
                        if (dataSnapshot.exists()) {
                            ...
                            if (role != null) {
                                if (role.equals("admin")) {
                                    ...
                                    Intent adminIntent = new Intent(UserPrecautions.this, AdminInterface.class);
                                    adminIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                    startActivity(adminIntent);
                                } else if (role.equals("consumer")) {
                                    // Handle actions for Consumer role
                                    Intent consumerIntent = new Intent(UserPrecautions.this, ConsumerInterface.class);
                                    ...
                                    Toast.makeText(UserPrecautions.this, "Unauthorized action for this role", Toast.LENGTH_SHORT).show();
                                }
                            }
                        }
                    }
            ...
            Toast.makeText(UserPrecautions.this, "Something went wrong", Toast.LENGTH_SHORT).show();
        }
