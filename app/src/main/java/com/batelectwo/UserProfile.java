    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavigationView.setOnItemSelectedListener(item -> {
            ...
            if (itemId == R.id.home_bottom) {
                Intent intent = new Intent(UserProfile.this, ConsumerInterface.class);
                startActivity(intent);
                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
                finish();
                return true;
            } else if (itemId == R.id.bill_bottom) {
                Intent intent = new Intent(UserProfile.this, BillActivity.class);
                startActivity(intent);
                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
                finish();
                return true;
            } else if (itemId == R.id.videos_bottom) {
                Intent intent = new Intent(UserProfile.this, VideoActivity.class);
                startActivity(intent);
                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
                finish();
                return true;
    ...
    private void showUserProfile(FirebaseUser firebaseUser) {
        ...
        buttonGenerateQR.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String email = ((TextView) findViewById(R.id.textViewShowEmail)).getText().toString();
                ...
                String username = ((TextView) findViewById(R.id.textViewShowUsername)).getText().toString();
                        ...
                        if (dataSnapshot.exists()) {
                            ...
                            if (role != null) {
                                ...
                                if (role.equals("admin")) {
                                    ...
                                    intent = new Intent(UserProfile.this, AdminInterface.class);
                                } else if (role.equals("consumer")) {
                                    // Handle actions for Consumer role
                                    intent = new Intent(UserProfile.this, ConsumerInterface.class);
                                } else {
                                    // Handle actions for other roles or roles not defined
                                    Toast.makeText(UserProfile.this, "Unauthorized action for this role", Toast.LENGTH_SHORT).show();
                                    return;
                                }
